...
font-size: 16px;">&nbsp; <a href="logout" class="btn btn-danger square-btn-adjust">Logout</a> </div>
				...
				<li class="text-center">
                  ...
                  <!--  <li>
                    ...
                    <li>
					   ...
					   <li>
                        <a class="active-menu" href="productQuantity"><i class="fa fa-barcode fa-2x"></i> Product Quantity</a>
                    </li>
					<li>
        ...
        <div id="page-wrapper" style="background-image:url(https://i.ibb.co/W3QBCJ8/Cannabot-backgraound.jpg)">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2 style="font-style:normal; font-weight: bold;">Product Quantity</h2>   
              ...
              <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                      ...
                      <!--  <br> <c:if test="${not empty msg}"><font color="blue">${msg}</font></c:if>
                              ...
                              <div class="dataTables_length" id ="dataTables_length">
                                    <label>
                                        ...
                                        <select name="dataTable_length" aria-controls="dataTable" class="custom-select custom-select-sm form-control form-control-sm" onchange="location = this.value;" >
                                            ...
                                            10</option>
                                            <option value="<c:url value="productQuantityNextPage?startpage=0&limit=25&currentPageNumber=0&pageCount=${pageCount}" /> " >
                                            25</option >
                                            <option value="<c:url value="productQuantityNextPage?startpage=0&limit=50&currentPageNumber=0&pageCount=${pageCount}" /> " >
                                            50</option>
                                            </c:if>
                                            <c:if test="${limit == 25}">
 											<option value="<c:url value="productQuantityNextPage?startpage=0&limit=10&currentPageNumber=${currentPageNumber}&pageCount=${pageCount}" /> " >
                                            10</option>
                                            <option value="" selected>
                                            25</option >
                                            <option value="<c:url value="productQuantityNextPage?startpage=0&limit=50&currentPageNumber=0&pageCount=${pageCount}" /> " >
                                            ...
                                            <c:if test="${limit == 50}">
                                            <option value="<c:url value="productQuantityNextPage?startpage=0&limit=10&currentPageNumber=0&pageCount=${pageCount}" /> " >
                                            10</option>
                                            <option value="<c:url value="productQuantityNextPage?startpage=0&limit=25&currentPageNumber=0&pageCount=${pageCount}" /> " >
                                            25</option >
                                            <option value="" selected>
                                    ...
                                    <label>
									<form name="" action="searchProductQuantity">
                                        Search
                                    ...
                                    <thead>
                                        <tr>
                                          ...
                                          <!--   <th class="th-hover">Creation Time</th>
                                            ...
                                            <th class="th-hover">Available Quantity</th>
                                    	...
                                    	<c:forEach items="${productlist}" var="product"  >
                                        	<c:if test="${product.isActive == 0}">
                                        		<tr class="odd gradeX">
	                                            	...
	                                            	<td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#DetailsModal${product.id}">Update Quantity</button></td>
                                   	  			</tr>
                                      	  	</c:if>
                                      	  	<c:if test="${product.isActive == 1}">
                                            	<tr class="odd gradeX" style ="background-color('#FF3933')">
	                                            	<td>${product.name}</td>
	                                        		<td>${product.categoryName}</td>
	                                        	 	<td>Inactive</td>
	                                        		<td>${product.totalQuantity}</td>
													...
													<div class="modal fade" id="DetailsModal${product.id}"
														...
														<div class="modal-dialog">
															...
															<div class="modal-content">
																...
																<form  name="quant" role="form" action="quantity" method="POST">
																...
																<div class="table">
																	<c:forEach items="${product.attribute}" var="attribute">
																						...
																						<div class="form-group">
																							<label for="usrname"><span
																								...
																								id="usrname" value="${attribute.weight}" name="weights[]"
																								readonly>
																						</div>
																						</div>
																						<div class="table-cell">
																						<div class="form-group">
																							<label for="Price"><span
																								...
																								value="${attribute.price}" name="prices[]" readonly>
																						</div>
																						</div>
																						<div class="table-cell">
																						<div class="form-group">
																							<label for="Price"><span
																								...
																								value="${attribute.quantity.quantity}" >
																						</div>
																						</div>
																  ...
																  <div class="modal-footer">
                                            							...
                                            							<div class="table-cell">
        																<input type="submit" class="btn btn-default"  value="Update" id="${product.id}" >
																		</div>
																	</div>
																	</div>
																	</form>
                                ...
                                <div class="pagination">
                                	 	<c:if test="${currentPageNumber > 0}">
  											<a href="<c:url value="productQuantityNextPage?startpage=${currentPageNumber - 1}&limit=${limit}&currentPageNumber=${currentPageNumber - 1}&pageCount=${pageCount}" /> ">&laquo;</a>
  											</c:if>
  											<a href="" class="active"><c:out value = "${currentPageNumber + 1}"/></a>
  											<c:if test="${currentPageNumber lt pageCount - 1}">
										    <a href="<c:url value="productQuantityNextPage?startpage=${currentPageNumber + 1}&limit=${limit}&currentPageNumber=${currentPageNumber + 1 }&pageCount=${pageCount}" />">&raquo;</a>
										   </c:if>
									</div>
    ...
    <script src="<c:url value="/assets/js/quantity.js" />" ></script> 
