...
<body>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-12">
										<c:if test="${sessionScope.role == 'superadmin'}">
											<a href="<c:url value='addAgentForm' />" class="btn btn-success"><i
												class="fa fa-edit "></i>Add Agent</a>
										</c:if>
									</div>
								</div>
								<br>
										...
										<label> <select name="dataTable_length"
											...
											onchange="location = this.value;">
												<c:if test="${limit == 10}">
													...
													<option
														value="<c:url value="/agentsNextPage?startpage=0&limit=25&currentPageNumber=0&pageCount=${pageCount}" /> ">
														25</option>
													<option
														value="<c:url value="/agentsNextPage?startpage=0&limit=50&currentPageNumber=0&pageCount=${pageCount}" /> ">
														50</option>
												</c:if>
												<c:if test="${limit == 25}">
													<option
														value="<c:url value="/agentsNextPage?startpage=0&limit=10&currentPageNumber=${currentPageNumber}&pageCount=${pageCount}" /> ">
														10</option>
												...
												<c:if test="${limit == 50}">
													<option
														value="<c:url value="/agentsNextPage?startpage=0&limit=10&currentPageNumber=0&pageCount=${pageCount}" /> ">
														10</option>
													<option
														value="<c:url value="/agentsNextPage?startpage=0&limit=25&currentPageNumber=0&pageCount=${pageCount}" /> ">
														25</option>
											...
											<tbody>
												...
												<c:forEach items="${listUsers}" var="user">
                                            	  ...
                                            	  <td>${user.dob}</td>-->
														...
														<td><a href="<c:url value='/editAgent/${user.id}' />"
														...
														<c:if test="${sessionScope.role eq 'superadmin'}">
															<td>
																<button class="btn btn-danger delete"
																	data-href="<c:url value='/removeAgent/${user.id}' />"
														...
														<table class="table table-hover">
															<tbody>
																...
																<tr>
																	...
																	<td></td>
																	<td class="h5" ><c:out value="${user.street}, ${user.city }, ${user.state }, zip code:${user.zip }"></c:out> </td>
																</tr>
	...
	<script src="<c:url value="/assets/js/UpdateStatusAgent.js" />"></script>
	<script>
