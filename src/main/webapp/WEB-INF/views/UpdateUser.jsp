                   ...
                   <!-- <li>
					...
					<li>
                        ...
                        <ul class="nav nav-second-level">
                            <li >
                                <a href="/Chat-Bot/users" class="active-menu" ><i class="fa fa-user fa-2x" aria-hidden="true"></i> Admin Management</a>
                            </li>
                            <li>
                                <a href="/Chat-Bot/agents"><i class="fa fa-user-secret fa-2x" aria-hidden="true"> </i>Agents Management</a>
                            </li>
...
<br/>										
                                     ...
                                     <input type="submit" value="Edit User" class="btn btn-success " onclick="return Validate()" >
...
<br/>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"  ></i></span>
                                            <input type="text" class="form-control" placeholder="Name" name="name" value="${userAdd.name}" required/>
                                        </div>
                                       ...
                                       <div class="form-group input-group">
                                         ...
                                         <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-home" ></i></span>
                                            <input type="text" class="form-control" placeholder="Address" name="address" value="${userAdd.address}" required/>
                                        </div>
                                     ...
                                     <input type="submit" value="Add User" class="btn btn-success " onclick="return Validate()">
                                    <!--   <a href="index.html" class="btn btn-success ">Register Me</a> -->
                                    <hr />
                                    </form>
                            </c:if>
